...
void man(char *name)
{
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("Usage : lseek File_Name ChangedInOffset StartPoint\n");
    }
        ...
        else if(count == 2)
        {
            ...
            else if(count == 3)
            {
                if(strcmp(command[0],"create") == 0)
                {
                    ...
                    if(ret >= 0)
                        printf("File is successfully cretaed with file descriptor : %d\n",ret);
                    if(ret == -1)
                        printf("ERROR : Incorrect parameters\n");
                    if(ret == -2)
                        printf("ERROR : There is no inodes\n");
                    if(ret == -3)
                        printf("EROR : File already exists\n");
                    if(ret == -4)
            ...
            else if(count == 4)
            {
                if(strcmp(command[0],"lseek") == 0)
                {
                    ...
                    if(fd == -1)
                    {
                        printf("ERROR : Inocorrect paramaeter\n");
                        continue;
                    }   
